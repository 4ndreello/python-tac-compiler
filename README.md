...
# Primeiro commit
git commit -m "Initial commit: Compilador com análise semântica e otimização"

# Adicionar remote (substitua pela URL do seu repositório)
git remote add origin https://github.com/4ndreello/projeto-compiladores.git
...
2. Nome do repositório: `projeto-compiladores`
3. Descrição: "Compilador educacional com análise semântica e otimização"
4. Tornar público ou privado conforme preferir
5. **Não** inicializar com README (já temos um)
6. Clicar em "Create repository"
7. Usar os comandos acima para fazer push
